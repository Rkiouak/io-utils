...
(ns protojure.io-utils.internal.grpc.codec.io
...
;;--------------------------------------------------------------------------------------------
(gen-class
 :name protojure.io-utils.internal.grpc.io.InputStream
...
(defn- is-available
  [^protojure.io-utils.internal.grpc.io.InputStream this]
...
(defn- is-read
  ...
  ([^protojure.io-utils.internal.grpc.io.InputStream this bytes offset len]
   (.parentRead this bytes offset len))
  ([^protojure.io-utils.internal.grpc.io.InputStream this bytes]
...
;;--------------------------------------------------------------------------------------------
(gen-class
 :name protojure.io-utils.internal.grpc.io.OutputStream
...
(defn- os-flush
  ...
  [^protojure.io-utils.internal.grpc.io.OutputStream this]
...
(defn- os-write-int
  [^protojure.io-utils.internal.grpc.io.OutputStream this b]
  (let [{:keys [ch]} (.state this)]
